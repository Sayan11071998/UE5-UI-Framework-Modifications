...
void EmptyLinkFunctionForGeneratedCodeUE5_Frontend_UI_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_UE5_Frontend_UI()
	{
		if (!Z_Registration_Info_UPackage__Script_UE5_Frontend_UI.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_UE5_Frontend_UI(Z_Construct_UPackage__Script_UE5_Frontend_UI, TEXT("/Script/UE5_Frontend_UI"), Z_Registration_Info_UPackage__Script_UE5_Frontend_UI, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x696FD264, 0xAA24FD26));
