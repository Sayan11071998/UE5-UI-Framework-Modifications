...
UE5_FRONTEND_UI_API UFunction* Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature();
...
struct Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics
{
	struct _Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms
	{
		FName OptionID;
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_ModifyReason_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_ModifyReason;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FDelegateFunctionParams FuncParams;
};
const UECodeGen_Private::FNamePropertyParams Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_OptionID = { "OptionID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms, OptionID), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FTextPropertyParams Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_OptionDisplayName = { "OptionDisplayName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms, OptionDisplayName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_ModifyReason_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_ModifyReason = { "ModifyReason", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms, ModifyReason), Z_Construct_UEnum_UE5_Frontend_UI_EOptionsListDataModifyReason, METADATA_PARAMS(0, nullptr) }; // 697031540
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_OptionID,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_OptionDisplayName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_ModifyReason_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::NewProp_ModifyReason,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_UE5_Frontend_UI, nullptr, "OnOptionValueChangedDelegate__DelegateSignature", Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FOnOptionValueChangedDelegate_DelegateWrapper(const FMulticastScriptDelegate& OnOptionValueChangedDelegate, FName OptionID, const FText& OptionDisplayName, EOptionsListDataModifyReason ModifyReason)
{
	struct _Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms
	{
		FName OptionID;
	...
	_Script_UE5_Frontend_UI_eventOnOptionValueChangedDelegate_Parms Parms;
	Parms.OptionID=OptionID;
	Parms.OptionDisplayName=OptionDisplayName;
	Parms.ModifyReason=ModifyReason;
	OnOptionValueChangedDelegate.ProcessMulticastDelegate<UObject>(&Parms);
}
...
struct Z_Construct_UClass_UFrontendUISubsystem_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OnOptionValueChanged_MetaData[] = {
	...
	static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnOptionValueChanged;
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UFrontendUISubsystem_Statics::NewProp_OnOptionValueChanged = { "OnOptionValueChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFrontendUISubsystem, OnOptionValueChanged), Z_Construct_UDelegateFunction_UE5_Frontend_UI_OnOptionValueChangedDelegate__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnOptionValueChanged_MetaData), NewProp_OnOptionValueChanged_MetaData) }; // 595686211
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UFrontendUISubsystem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UFrontendUISubsystem_Statics::NewProp_OnOptionValueChanged,
...
struct Z_CompiledInDeferFile_FID_Users_sayan_Projects_UE5_UI_Framework_Modifications_UE5_Frontend_UI_Source_UE5_Frontend_UI_Public_Subsystems_FrontendUISubsystem_h__Script_UE5_Frontend_UI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UFrontendUISubsystem, UFrontendUISubsystem::StaticClass, TEXT("UFrontendUISubsystem"), &Z_Registration_Info_UClass_UFrontendUISubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFrontendUISubsystem), 2725174068U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_sayan_Projects_UE5_UI_Framework_Modifications_UE5_Frontend_UI_Source_UE5_Frontend_UI_Public_Subsystems_FrontendUISubsystem_h__Script_UE5_Frontend_UI_1426264289(TEXT("/Script/UE5_Frontend_UI"),
